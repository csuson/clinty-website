/** Default layout matching ~/Downloads/crossword-13273.h5p (H5P.Crossword 0.5). */

export const crosswordLayoutDefaults = {
...
export function buildCrosswordWord(clue, answer) {
  return {
    fixWord: false,
    orientation: 'across',
    clue,
...
export function buildCrosswordContent({ taskDescription = '', words }) {
  return {
    taskDescription,
    words,
    ...crosswordLayoutDefaults,
  }
}
