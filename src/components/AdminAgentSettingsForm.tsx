...
export function toAgentSettingsPayload(form: CreateAgentSettingsInput): CreateAgentSettingsInput {
  return {
    ...
    multiple_booking_enabled: form.multiple_booking_enabled ?? false,
    overbook_enabled: form.overbook_enabled ?? false,
    max_bookings_per_slot: form.max_bookings_per_slot ?? 2,
    appointment_reminders_enabled: form.appointment_reminders_enabled ?? true,
    appointment_reminder_email_hours: form.appointment_reminder_email_hours?.trim() || '24',
    appointment_reminder_whatsapp_hours: form.appointment_reminder_whatsapp_hours?.trim() || '2',
    ...
    email_ad_enabled: form.email_ad_enabled ?? true,
